...
\begin{center}
    \textbf{\Large Junior Data Analyst}
\end{left}
\vspace{0.5em}
...
Graduanda em Análise e Desenvolvimento de Sistemas pela Fatec Carapicuíba, com foco em Análise de Dados. Graduada em História pela Universidade Santo Amaro. Experiência em pesquisa e análise de dados, organização da informação e modelagem de dados. Conhecimento em SQL, ETL, Python (Pandas, NumPy) e Power BI. Habilidades em pensamento analítico, resolução de problemas e comunicação eficaz. 
...
\entry{WoMakersCode}{\faCalendar \space 2025}{Bootcamp Data Analytics Instituto Localiza}{\faMapMarker \space São Paulo - SP}
...
\item Idiomas: Português - nativo, Inglês - avançado, Espanhol - intermediário.
